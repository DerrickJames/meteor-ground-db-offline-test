...
/////////////////////////////////////////////////////////////////////////////////////////     // 297
//                                                                                     //     // 298
// packages/logging/logging_cordova.js                                                 //     // 299
//                                                                                     //     // 300
/////////////////////////////////////////////////////////////////////////////////////////     // 301
                                                                                       //     // 302
// Log all uncaught errors so they can be printed to the developer.                    // 1   // 303
// But since Android's adb catlog already prints the uncaught exceptions, we           // 2   // 304
// can disable it for Android.                                                         // 3   // 305
if (! /Android/i.test(navigator.userAgent)) {                                          // 4   // 306
  window.onerror = function (msg, url, line) {                                         // 5   // 307
    // Cut off the url prefix, the meaningful part always starts at 'www/' in          // 6   // 308
    // Cordova apps.                                                                   // 7   // 309
    url = url.replace(/^.*?\/www\//, '');                                              // 8   // 310
    console.log('Uncaught Error: ' + msg + ':' + line + ':' + url);                    // 9   // 311
  };                                                                                   // 10  // 312
}                                                                                      // 11  // 313
                                                                                       // 12  // 314
                                                                                       // 13  // 315
