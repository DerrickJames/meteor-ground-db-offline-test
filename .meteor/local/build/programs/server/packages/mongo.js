...
MongoConnection.prototype._ensureIndex = function (collectionName, index,                                             // 781
                                                   options) {                                                         // 782
  var self = this;                                                                                                    // 783
  options = _.extend({safe: true}, options);                                                                          // 784
                                                                                                                      // 785
  // We expect this function to be called at startup, not from within a method,                                       // 786
  // so we don't interact with the write fence.                                                                       // 787
  var collection = self.rawCollection(collectionName);                                                                // 788
  var future = new Future;                                                                                            // 789
  var indexName = collection.ensureIndex(index, options, future.resolver());                                          // 790
  future.wait();                                                                                                      // 791
};                                                                                                                    // 792
MongoConnection.prototype._dropIndex = function (collectionName, index) {                                             // 793
  var self = this;                                                                                                    // 794
                                                                                                                      // 795
  // This function is only used by test code, not within a method, so we don't                                        // 796
  // interact with the write fence.                                                                                   // 797
  var collection = self.rawCollection(collectionName);                                                                // 798
  var future = new Future;                                                                                            // 799
  var indexName = collection.dropIndex(index, future.resolver());                                                     // 800
  future.wait();                                                                                                      // 801
};                                                                                                                    // 802
                                                                                                                      // 803
// CURSORS                                                                                                            // 804
                                                                                                                      // 805
// There are several classes which relate to cursors:                                                                 // 806
//                                                                                                                    // 807
// CursorDescription represents the arguments used to construct a cursor:                                             // 808
// collectionName, selector, and (find) options.  Because it is used as a key                                         // 809
// for cursor de-dup, everything in it should either be JSON-stringifiable or                                         // 810
// not affect observeChanges output (eg, options.transform functions are not                                          // 811
// stringifiable but do not affect observeChanges).                                                                   // 812
//                                                                                                                    // 813
// SynchronousCursor is a wrapper around a MongoDB cursor                                                             // 814
// which includes fully-synchronous versions of forEach, etc.                                                         // 815
//                                                                                                                    // 816
// Cursor is the cursor object returned from find(), which implements the                                             // 817
// documented Mongo.Collection cursor API.  It wraps a CursorDescription and a                                        // 818
// SynchronousCursor (lazily: it doesn't contact Mongo until you call a method                                        // 819
// like fetch or forEach on it).                                                                                      // 820
//                                                                                                                    // 821
// ObserveHandle is the "observe handle" returned from observeChanges. It has a                                       // 822
// reference to an ObserveMultiplexer.                                                                                // 823
//                                                                                                                    // 824
// ObserveMultiplexer allows multiple identical ObserveHandles to be driven by a                                      // 825
// single observe driver.                                                                                             // 826
//                                                                                                                    // 827
// There are two "observe drivers" which drive ObserveMultiplexers:                                                   // 828
//   - PollingObserveDriver caches the results of a query and reruns it when                                          // 829
//     necessary.                                                                                                     // 830
//   - OplogObserveDriver follows the Mongo operation log to directly observe                                         // 831
//     database changes.                                                                                              // 832
// Both implementations follow the same simple interface: when you create them,                                       // 833
// they start sending observeChanges callbacks (and a ready() invocation) to                                          // 834
// their ObserveMultiplexer, and you stop them by calling their stop() method.                                        // 835
                                                                                                                      // 836
CursorDescription = function (collectionName, selector, options) {                                                    // 837
  var self = this;                                                                                                    // 838
  self.collectionName = collectionName;                                                                               // 839
  self.selector = Mongo.Collection._rewriteSelector(selector);                                                        // 840
  self.options = options || {};                                                                                       // 841
};                                                                                                                    // 842
                                                                                                                      // 843
Cursor = function (mongo, cursorDescription) {                                                                        // 844
  var self = this;                                                                                                    // 845
                                                                                                                      // 846
  self._mongo = mongo;                                                                                                // 847
  self._cursorDescription = cursorDescription;                                                                        // 848
  self._synchronousCursor = null;                                                                                     // 849
};                                                                                                                    // 850
                                                                                                                      // 851
_.each(['forEach', 'map', 'fetch', 'count'], function (method) {                                                      // 852
  Cursor.prototype[method] = function () {                                                                            // 853
    var self = this;                                                                                                  // 854
                                                                                                                      // 855
    // You can only observe a tailable cursor.                                                                        // 856
    if (self._cursorDescription.options.tailable)                                                                     // 857
      throw new Error("Cannot call " + method + " on a tailable cursor");                                             // 858
                                                                                                                      // 859
    if (!self._synchronousCursor) {                                                                                   // 860
      self._synchronousCursor = self._mongo._createSynchronousCursor(                                                 // 861
        self._cursorDescription, {                                                                                    // 862
          // Make sure that the "self" argument to forEach/map callbacks is the                                       // 863
          // Cursor, not the SynchronousCursor.                                                                       // 864
          selfForIteration: self,                                                                                     // 865
          useTransform: true                                                                                          // 866
        });                                                                                                           // 867
    }                                                                                                                 // 868
                                                                                                                      // 869
    return self._synchronousCursor[method].apply(                                                                     // 870
      self._synchronousCursor, arguments);                                                                            // 871
  };                                                                                                                  // 872
});                                                                                                                   // 873
                                                                                                                      // 874
// Since we don't actually have a "nextObject" interface, there's really no                                           // 875
// reason to have a "rewind" interface.  All it did was make multiple calls                                           // 876
// to fetch/map/forEach return nothing the second time.                                                               // 877
// XXX COMPAT WITH 0.8.1                                                                                              // 878
Cursor.prototype.rewind = function () {                                                                               // 879
};                                                                                                                    // 880
                                                                                                                      // 881
Cursor.prototype.getTransform = function () {                                                                         // 882
  return this._cursorDescription.options.transform;                                                                   // 883
};                                                                                                                    // 884
                                                                                                                      // 885
// When you call Meteor.publish() with a function that returns a Cursor, we need                                      // 886
// to transmute it into the equivalent subscription.  This is the function that                                       // 887
// does that.                                                                                                         // 888
                                                                                                                      // 889
Cursor.prototype._publishCursor = function (sub) {                                                                    // 890
  var self = this;                                                                                                    // 891
  var collection = self._cursorDescription.collectionName;                                                            // 892
  return Mongo.Collection._publishCursor(self, sub, collection);                                                      // 893
};                                                                                                                    // 894
                                                                                                                      // 895
// Used to guarantee that publish functions return at most one cursor per                                             // 896
// collection. Private, because we might later have cursors that include                                              // 897
// documents from multiple collections somehow.                                                                       // 898
Cursor.prototype._getCollectionName = function () {                                                                   // 899
  var self = this;                                                                                                    // 900
  return self._cursorDescription.collectionName;                                                                      // 901
}                                                                                                                     // 902
                                                                                                                      // 903
Cursor.prototype.observe = function (callbacks) {                                                                     // 904
  var self = this;                                                                                                    // 905
  return LocalCollection._observeFromObserveChanges(self, callbacks);                                                 // 906
};                                                                                                                    // 907
                                                                                                                      // 908
Cursor.prototype.observeChanges = function (callbacks) {                                                              // 909
  var self = this;                                                                                                    // 910
  var ordered = LocalCollection._observeChangesCallbacksAreOrdered(callbacks);                                        // 911
  return self._mongo._observeChanges(                                                                                 // 912
    self._cursorDescription, ordered, callbacks);                                                                     // 913
};                                                                                                                    // 914
                                                                                                                      // 915
MongoConnection.prototype._createSynchronousCursor = function(                                                        // 916
    cursorDescription, options) {                                                                                     // 917
  var self = this;                                                                                                    // 918
  options = _.pick(options || {}, 'selfForIteration', 'useTransform');                                                // 919
                                                                                                                      // 920
  var collection = self.rawCollection(cursorDescription.collectionName);                                              // 921
  var cursorOptions = cursorDescription.options;                                                                      // 922
  var mongoOptions = {                                                                                                // 923
    sort: cursorOptions.sort,                                                                                         // 924
    limit: cursorOptions.limit,                                                                                       // 925
    skip: cursorOptions.skip                                                                                          // 926
  };                                                                                                                  // 927
                                                                                                                      // 928
  // Do we want a tailable cursor (which only works on capped collections)?                                           // 929
  if (cursorOptions.tailable) {                                                                                       // 930
    // We want a tailable cursor...                                                                                   // 931
    mongoOptions.tailable = true;                                                                                     // 932
    // ... and for the server to wait a bit if any getMore has no data (rather                                        // 933
    // than making us put the relevant sleeps in the client)...                                                       // 934
    mongoOptions.awaitdata = true;                                                                                    // 935
    // ... and to keep querying the server indefinitely rather than just 5 times                                      // 936
    // if there's no more data.                                                                                       // 937
    mongoOptions.numberOfRetries = -1;                                                                                // 938
    // And if this is on the oplog collection and the cursor specifies a 'ts',                                        // 939
    // then set the undocumented oplog replay flag, which does a special scan to                                      // 940
    // find the first document (instead of creating an index on ts). This is a                                        // 941
    // very hard-coded Mongo flag which only works on the oplog collection and                                        // 942
    // only works with the ts field.                                                                                  // 943
    if (cursorDescription.collectionName === OPLOG_COLLECTION &&                                                      // 944
        cursorDescription.selector.ts) {                                                                              // 945
      mongoOptions.oplogReplay = true;                                                                                // 946
    }                                                                                                                 // 947
  }                                                                                                                   // 948
                                                                                                                      // 949
  var dbCursor = collection.find(                                                                                     // 950
    replaceTypes(cursorDescription.selector, replaceMeteorAtomWithMongo),                                             // 951
    cursorOptions.fields, mongoOptions);                                                                              // 952
                                                                                                                      // 953
  return new SynchronousCursor(dbCursor, cursorDescription, options);                                                 // 954
};                                                                                                                    // 955
                                                                                                                      // 956
var SynchronousCursor = function (dbCursor, cursorDescription, options) {                                             // 957
  var self = this;                                                                                                    // 958
  options = _.pick(options || {}, 'selfForIteration', 'useTransform');                                                // 959
                                                                                                                      // 960
  self._dbCursor = dbCursor;                                                                                          // 961
  self._cursorDescription = cursorDescription;                                                                        // 962
  // The "self" argument passed to forEach/map callbacks. If we're wrapped                                            // 963
  // inside a user-visible Cursor, we want to provide the outer cursor!                                               // 964
  self._selfForIteration = options.selfForIteration || self;                                                          // 965
  if (options.useTransform && cursorDescription.options.transform) {                                                  // 966
    self._transform = LocalCollection.wrapTransform(                                                                  // 967
      cursorDescription.options.transform);                                                                           // 968
  } else {                                                                                                            // 969
    self._transform = null;                                                                                           // 970
  }                                                                                                                   // 971
                                                                                                                      // 972
  // Need to specify that the callback is the first argument to nextObject,                                           // 973
  // since otherwise when we try to call it with no args the driver will                                              // 974
  // interpret "undefined" first arg as an options hash and crash.                                                    // 975
  self._synchronousNextObject = Future.wrap(                                                                          // 976
    dbCursor.nextObject.bind(dbCursor), 0);                                                                           // 977
  self._synchronousCount = Future.wrap(dbCursor.count.bind(dbCursor));                                                // 978
  self._visitedIds = new LocalCollection._IdMap;                                                                      // 979
};                                                                                                                    // 980
                                                                                                                      // 981
_.extend(SynchronousCursor.prototype, {                                                                               // 982
  _nextObject: function () {                                                                                          // 983
    var self = this;                                                                                                  // 984
                                                                                                                      // 985
    while (true) {                                                                                                    // 986
      var doc = self._synchronousNextObject().wait();                                                                 // 987
                                                                                                                      // 988
      if (!doc) return null;                                                                                          // 989
      doc = replaceTypes(doc, replaceMongoAtomWithMeteor);                                                            // 990
                                                                                                                      // 991
      if (!self._cursorDescription.options.tailable && _.has(doc, '_id')) {                                           // 992
        // Did Mongo give us duplicate documents in the same cursor? If so,                                           // 993
        // ignore this one. (Do this before the transform, since transform might                                      // 994
        // return some unrelated value.) We don't do this for tailable cursors,                                       // 995
        // because we want to maintain O(1) memory usage. And if there isn't _id                                      // 996
        // for some reason (maybe it's the oplog), then we don't do this either.                                      // 997
        // (Be careful to do this for falsey but existing _id, though.)                                               // 998
        if (self._visitedIds.has(doc._id)) continue;                                                                  // 999
        self._visitedIds.set(doc._id, true);                                                                          // 1000
      }                                                                                                               // 1001
                                                                                                                      // 1002
      if (self._transform)                                                                                            // 1003
        doc = self._transform(doc);                                                                                   // 1004
                                                                                                                      // 1005
      return doc;                                                                                                     // 1006
    }                                                                                                                 // 1007
  },                                                                                                                  // 1008
                                                                                                                      // 1009
  forEach: function (callback, thisArg) {                                                                             // 1010
    var self = this;                                                                                                  // 1011
                                                                                                                      // 1012
    // Get back to the beginning.                                                                                     // 1013
    self._rewind();                                                                                                   // 1014
                                                                                                                      // 1015
    // We implement the loop ourself instead of using self._dbCursor.each,                                            // 1016
    // because "each" will call its callback outside of a fiber which makes it                                        // 1017
    // much more complex to make this function synchronous.                                                           // 1018
    var index = 0;                                                                                                    // 1019
    while (true) {                                                                                                    // 1020
      var doc = self._nextObject();                                                                                   // 1021
      if (!doc) return;                                                                                               // 1022
      callback.call(thisArg, doc, index++, self._selfForIteration);                                                   // 1023
    }                                                                                                                 // 1024
  },                                                                                                                  // 1025
                                                                                                                      // 1026
  // XXX Allow overlapping callback executions if callback yields.                                                    // 1027
  map: function (callback, thisArg) {                                                                                 // 1028
    var self = this;                                                                                                  // 1029
    var res = [];                                                                                                     // 1030
    self.forEach(function (doc, index) {                                                                              // 1031
      res.push(callback.call(thisArg, doc, index, self._selfForIteration));                                           // 1032
    });                                                                                                               // 1033
    return res;                                                                                                       // 1034
  },                                                                                                                  // 1035
                                                                                                                      // 1036
  _rewind: function () {                                                                                              // 1037
    var self = this;                                                                                                  // 1038
                                                                                                                      // 1039
    // known to be synchronous                                                                                        // 1040
    self._dbCursor.rewind();                                                                                          // 1041
                                                                                                                      // 1042
    self._visitedIds = new LocalCollection._IdMap;                                                                    // 1043
  },                                                                                                                  // 1044
                                                                                                                      // 1045
  // Mostly usable for tailable cursors.                                                                              // 1046
  close: function () {                                                                                                // 1047
    var self = this;                                                                                                  // 1048
                                                                                                                      // 1049
    self._dbCursor.close();                                                                                           // 1050
  },                                                                                                                  // 1051
                                                                                                                      // 1052
  fetch: function () {                                                                                                // 1053
    var self = this;                                                                                                  // 1054
    return self.map(_.identity);                                                                                      // 1055
  },                                                                                                                  // 1056
                                                                                                                      // 1057
  count: function () {                                                                                                // 1058
    var self = this;                                                                                                  // 1059
    return self._synchronousCount().wait();                                                                           // 1060
  },                                                                                                                  // 1061
                                                                                                                      // 1062
  // This method is NOT wrapped in Cursor.                                                                            // 1063
  getRawObjects: function (ordered) {                                                                                 // 1064
    var self = this;                                                                                                  // 1065
    if (ordered) {                                                                                                    // 1066
      return self.fetch();                                                                                            // 1067
    } else {                                                                                                          // 1068
      var results = new LocalCollection._IdMap;                                                                       // 1069
      self.forEach(function (doc) {                                                                                   // 1070
        results.set(doc._id, doc);                                                                                    // 1071
      });                                                                                                             // 1072
      return results;                                                                                                 // 1073
    }                                                                                                                 // 1074
  }                                                                                                                   // 1075
                                                                                                                      ...
                                                                                                                      // 1077
MongoConnection.prototype.tail = function (cursorDescription, docCallback) {                                          // 1078
  var self = this;                                                                                                    // 1079
  if (!cursorDescription.options.tailable)                                                                            // 1080
    throw new Error("Can only tail a tailable cursor");                                                               // 1081
                                                                                                                      // 1082
  var cursor = self._createSynchronousCursor(cursorDescription);                                                      // 1083
                                                                                                                      // 1084
  var stopped = false;                                                                                                // 1085
  var lastTS = undefined;                                                                                             // 1086
  var loop = function () {                                                                                            // 1087
    while (true) {                                                                                                    // 1088
      if (stopped)                                                                                                    // 1089
        return;                                                                                                       // 1090
      try {                                                                                                           // 1091
        var doc = cursor._nextObject();                                                                               // 1092
      } catch (err) {                                                                                                 // 1093
        // There's no good way to figure out if this was actually an error                                            // 1094
        // from Mongo. Ah well. But either way, we need to retry the cursor                                           // 1095
        // (unless the failure was because the observe got stopped).                                                  // 1096
        doc = null;                                                                                                   // 1097
      }                                                                                                               // 1098
      // Since cursor._nextObject can yield, we need to check again to see if                                         // 1099
      // we've been stopped before calling the callback.                                                              // 1100
      if (stopped)                                                                                                    // 1101
        return;                                                                                                       // 1102
      if (doc) {                                                                                                      // 1103
        // If a tailable cursor contains a "ts" field, use it to recreate the                                         // 1104
        // cursor on error. ("ts" is a standard that Mongo uses internally for                                        // 1105
        // the oplog, and there's a special flag that lets you do binary search                                       // 1106
        // on it instead of needing to use an index.)                                                                 // 1107
        lastTS = doc.ts;                                                                                              // 1108
        docCallback(doc);                                                                                             // 1109
      } else {                                                                                                        // 1110
        var newSelector = _.clone(cursorDescription.selector);                                                        // 1111
        if (lastTS) {                                                                                                 // 1112
          newSelector.ts = {$gt: lastTS};                                                                             // 1113
        }                                                                                                             // 1114
        cursor = self._createSynchronousCursor(new CursorDescription(                                                 // 1115
          cursorDescription.collectionName,                                                                           // 1116
          newSelector,                                                                                                // 1117
          cursorDescription.options));                                                                                // 1118
        // Mongo failover takes many seconds.  Retry in a bit.  (Without this                                         // 1119
        // setTimeout, we peg the CPU at 100% and never notice the actual                                             // 1120
        // failover.                                                                                                  // 1121
        Meteor.setTimeout(loop, 100);                                                                                 // 1122
        break;                                                                                                        // 1123
      }                                                                                                               // 1124
    }                                                                                                                 // 1125
  };                                                                                                                  // 1126
                                                                                                                      // 1127
  Meteor.defer(loop);                                                                                                 // 1128
                                                                                                                      // 1129
  return {                                                                                                            // 1130
    stop: function () {                                                                                               // 1131
      stopped = true;                                                                                                 // 1132
      cursor.close();                                                                                                 // 1133
                                                                                                                      ...
                                                                                                                      // 1137
MongoConnection.prototype._observeChanges = function (                                                                // 1138
    cursorDescription, ordered, callbacks) {                                                                          // 1139
  var self = this;                                                                                                    // 1140
                                                                                                                      // 1141
  if (cursorDescription.options.tailable) {                                                                           // 1142
    return self._observeChangesTailable(cursorDescription, ordered, callbacks);                                       // 1143
  }                                                                                                                   // 1144
                                                                                                                      // 1145
  // You may not filter out _id when observing changes, because the id is a core                                      // 1146
  // part of the observeChanges API.                                                                                  // 1147
  if (cursorDescription.options.fields &&                                                                             // 1148
      (cursorDescription.options.fields._id === 0 ||                                                                  // 1149
       cursorDescription.options.fields._id === false)) {                                                             // 1150
    throw Error("You may not observe a cursor with {fields: {_id: 0}}");                                              // 1151
  }                                                                                                                   // 1152
                                                                                                                      // 1153
  var observeKey = JSON.stringify(                                                                                    // 1154
    _.extend({ordered: ordered}, cursorDescription));                                                                 // 1155
                                                                                                                      // 1156
  var multiplexer, observeDriver;                                                                                     // 1157
  var firstHandle = false;                                                                                            // 1158
                                                                                                                      // 1159
  // Find a matching ObserveMultiplexer, or create a new one. This next block is                                      // 1160
  // guaranteed to not yield (and it doesn't call anything that can observe a                                         // 1161
  // new query), so no other calls to this function can interleave with it.                                           // 1162
  Meteor._noYieldsAllowed(function () {                                                                               // 1163
    if (_.has(self._observeMultiplexers, observeKey)) {                                                               // 1164
      multiplexer = self._observeMultiplexers[observeKey];                                                            // 1165
    } else {                                                                                                          // 1166
      firstHandle = true;                                                                                             // 1167
      // Create a new ObserveMultiplexer.                                                                             // 1168
      multiplexer = new ObserveMultiplexer({                                                                          // 1169
        ordered: ordered,                                                                                             // 1170
        onStop: function () {                                                                                         // 1171
          delete self._observeMultiplexers[observeKey];                                                               // 1172
          observeDriver.stop();                                                                                       // 1173
        }                                                                                                             // 1174
      });                                                                                                             // 1175
      self._observeMultiplexers[observeKey] = multiplexer;                                                            // 1176
    }                                                                                                                 // 1177
  });                                                                                                                 // 1178
                                                                                                                      // 1179
  var observeHandle = new ObserveHandle(multiplexer, callbacks);                                                      // 1180
                                                                                                                      // 1181
  if (firstHandle) {                                                                                                  // 1182
    var matcher, sorter;                                                                                              // 1183
    var canUseOplog = _.all([                                                                                         // 1184
      function () {                                                                                                   // 1185
        // At a bare minimum, using the oplog requires us to have an oplog, to                                        // 1186
        // want unordered callbacks, and to not want a callback on the polls                                          // 1187
        // that won't happen.                                                                                         // 1188
        return self._oplogHandle && !ordered &&                                                                       // 1189
          !callbacks._testOnlyPollCallback;                                                                           // 1190
      }, function () {                                                                                                // 1191
        // We need to be able to compile the selector. Fall back to polling for                                       // 1192
        // some newfangled $selector that minimongo doesn't support yet.                                              // 1193
        try {                                                                                                         // 1194
          matcher = new Minimongo.Matcher(cursorDescription.selector);                                                // 1195
          return true;                                                                                                // 1196
        } catch (e) {                                                                                                 // 1197
          // XXX make all compilation errors MinimongoError or something                                              // 1198
          //     so that this doesn't ignore unrelated exceptions                                                     // 1199
          return false;                                                                                               // 1200
        }                                                                                                             // 1201
      }, function () {                                                                                                // 1202
        // ... and the selector itself needs to support oplog.                                                        // 1203
        return OplogObserveDriver.cursorSupported(cursorDescription, matcher);                                        // 1204
      }, function () {                                                                                                // 1205
        // And we need to be able to compile the sort, if any.  eg, can't be                                          // 1206
        // {$natural: 1}.                                                                                             // 1207
        if (!cursorDescription.options.sort)                                                                          // 1208
          return true;                                                                                                // 1209
        try {                                                                                                         // 1210
          sorter = new Minimongo.Sorter(cursorDescription.options.sort,                                               // 1211
                                        { matcher: matcher });                                                        // 1212
          return true;                                                                                                // 1213
        } catch (e) {                                                                                                 // 1214
          // XXX make all compilation errors MinimongoError or something                                              // 1215
          //     so that this doesn't ignore unrelated exceptions                                                     // 1216
          return false;                                                                                               // 1217
        }                                                                                                             // 1218
      }], function (f) { return f(); });  // invoke each function                                                     // 1219
                                                                                                                      // 1220
    var driverClass = canUseOplog ? OplogObserveDriver : PollingObserveDriver;                                        // 1221
    observeDriver = new driverClass({                                                                                 // 1222
      cursorDescription: cursorDescription,                                                                           // 1223
      mongoHandle: self,                                                                                              // 1224
      multiplexer: multiplexer,                                                                                       // 1225
      ordered: ordered,                                                                                               // 1226
      matcher: matcher,  // ignored by polling                                                                        // 1227
      sorter: sorter,  // ignored by polling                                                                          // 1228
      _testOnlyPollCallback: callbacks._testOnlyPollCallback                                                          // 1229
    });                                                                                                               // 1230
                                                                                                                      // 1231
    // This field is only set for use in tests.                                                                       // 1232
    multiplexer._observeDriver = observeDriver;                                                                       // 1233
  }                                                                                                                   // 1234
                                                                                                                      // 1235
  // Blocks until the initial adds have been sent.                                                                    // 1236
  multiplexer.addHandleAndSendInitialAdds(observeHandle);                                                             // 1237
                                                                                                                      // 1238
  return observeHandle;                                                                                               // 1239
};                                                                                                                    // 1240
                                                                                                                      // 1241
// Listen for the invalidation messages that will trigger us to poll the                                              // 1242
// database for changes. If this selector specifies specific IDs, specify them                                        // 1243
// here, so that updates to different specific IDs don't cause us to poll.                                            // 1244
// listenCallback is the same kind of (notification, complete) callback passed                                        // 1245
// to InvalidationCrossbar.listen.                                                                                    // 1246
                                                                                                                      // 1247
listenAll = function (cursorDescription, listenCallback) {                                                            // 1248
  var listeners = [];                                                                                                 // 1249
  forEachTrigger(cursorDescription, function (trigger) {                                                              // 1250
    listeners.push(DDPServer._InvalidationCrossbar.listen(                                                            // 1251
      trigger, listenCallback));                                                                                      // 1252
  });                                                                                                                 // 1253
                                                                                                                      // 1254
  return {                                                                                                            // 1255
    stop: function () {                                                                                               // 1256
      _.each(listeners, function (listener) {                                                                         // 1257
        listener.stop();                                                                                              // 1258
      });                                                                                                             // 1259
    }                                                                                                                 // 1260
  };                                                                                                                  // 1261
                                                                                                                      ...
                                                                                                                      // 1263
forEachTrigger = function (cursorDescription, triggerCallback) {                                                      // 1264
  var key = {collection: cursorDescription.collectionName};                                                           // 1265
  var specificIds = LocalCollection._idsMatchedBySelector(                                                            // 1266
    cursorDescription.selector);                                                                                      // 1267
  if (specificIds) {                                                                                                  // 1268
    _.each(specificIds, function (id) {                                                                               // 1269
      triggerCallback(_.extend({id: id}, key));                                                                       // 1270
    });                                                                                                               // 1271
    triggerCallback(_.extend({dropCollection: true, id: null}, key));                                                 // 1272
  } else {                                                                                                            // 1273
    triggerCallback(key);                                                                                             // 1274
  }                                                                                                                   // 1275
  // Everyone cares about the database being dropped.                                                                 // 1276
  triggerCallback({ dropDatabase: true });                                                                            // 1277
};                                                                                                                    // 1278
                                                                                                                      // 1279
// observeChanges for tailable cursors on capped collections.                                                         // 1280
//                                                                                                                    // 1281
// Some differences from normal cursors:                                                                              // 1282
//   - Will never produce anything other than 'added' or 'addedBefore'. If you                                        // 1283
//     do update a document that has already been produced, this will not notice                                      // 1284
//     it.                                                                                                            // 1285
//   - If you disconnect and reconnect from Mongo, it will essentially restart                                        // 1286
//     the query, which will lead to duplicate results. This is pretty bad,                                           // 1287
//     but if you include a field called 'ts' which is inserted as                                                    // 1288
//     new MongoInternals.MongoTimestamp(0, 0) (which is initialized to the                                           // 1289
//     current Mongo-style timestamp), we'll be able to find the place to                                             // 1290
//     restart properly. (This field is specifically understood by Mongo with an                                      // 1291
//     optimization which allows it to find the right place to start without                                          // 1292
//     an index on ts. It's how the oplog works.)                                                                     // 1293
//   - No callbacks are triggered synchronously with the call (there's no                                             // 1294
//     differentiation between "initial data" and "later changes"; everything                                         // 1295
//     that matches the query gets sent asynchronously).                                                              // 1296
//   - De-duplication is not implemented.                                                                             // 1297
//   - Does not yet interact with the write fence. Probably, this should work by                                      // 1298
//     ignoring removes (which don't work on capped collections) and updates                                          // 1299
//     (which don't affect tailable cursors), and just keeping track of the ID                                        // 1300
//     of the inserted object, and closing the write fence once you get to that                                       // 1301
//     ID (or timestamp?).  This doesn't work well if the document doesn't match                                      // 1302
//     the query, though.  On the other hand, the write fence can close                                               // 1303
//     immediately if it does not match the query. So if we trust minimongo                                           // 1304
//     enough to accurately evaluate the query against the write fence, we                                            // 1305
//     should be able to do this...  Of course, minimongo doesn't even support                                        // 1306
//     Mongo Timestamps yet.                                                                                          // 1307
MongoConnection.prototype._observeChangesTailable = function (                                                        // 1308
    cursorDescription, ordered, callbacks) {                                                                          // 1309
  var self = this;                                                                                                    // 1310
                                                                                                                      // 1311
  // Tailable cursors only ever call added/addedBefore callbacks, so it's an                                          // 1312
  // error if you didn't provide them.                                                                                // 1313
  if ((ordered && !callbacks.addedBefore) ||                                                                          // 1314
      (!ordered && !callbacks.added)) {                                                                               // 1315
    throw new Error("Can't observe an " + (ordered ? "ordered" : "unordered")                                         // 1316
                    + " tailable cursor without a "                                                                   // 1317
                    + (ordered ? "addedBefore" : "added") + " callback");                                             // 1318
  }                                                                                                                   // 1319
                                                                                                                      // 1320
  return self.tail(cursorDescription, function (doc) {                                                                // 1321
    var id = doc._id;                                                                                                 // 1322
    delete doc._id;                                                                                                   // 1323
    // The ts is an implementation detail. Hide it.                                                                   // 1324
    delete doc.ts;                                                                                                    // 1325
    if (ordered) {                                                                                                    // 1326
      callbacks.addedBefore(id, doc, null);                                                                           // 1327
    } else {                                                                                                          // 1328
      callbacks.added(id, doc);                                                                                       // 1329
    }                                                                                                                 // 1330
  });                                                                                                                 // 1331
};                                                                                                                    // 1332
                                                                                                                      // 1333
// XXX We probably need to find a better way to expose this. Right now                                                // 1334
// it's only used by tests, but in fact you need it in normal                                                         // 1335
// operation to interact with capped collections.                                                                     // 1336
MongoInternals.MongoTimestamp = MongoDB.Timestamp;                                                                    // 1337
                                                                                                                      // 1338
MongoInternals.Connection = MongoConnection;                                                                          // 1339
                                                                                                                      // 1340
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      // 1350
}).call(this);                                                                                                        // 1351
